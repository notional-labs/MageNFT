...
describe("AminoTypes", () => {
    describe("toAmino", () => {
        it("works for MsgStoreCode", () => {
            ...
            const aminoMsg = new stargate_1.AminoTypes({ prefix: "cosmos", additions: aminotypes_1.cosmWasmTypes }).toAmino({
    ...
    describe("fromAmino", () => {
        it("works for MsgStoreCode", () => {
            ...
            const msg = new stargate_1.AminoTypes({ prefix: "cosmos", additions: aminotypes_1.cosmWasmTypes }).fromAmino(aminoMsg);
            const expectedValue = {
                sender: "cosmos1pkptre7fdkl6gfrzlesjjvhxhlc3r4gmmk8rs6",
                wasmByteCode: (0, encoding_1.fromBase64)("WUVMTE9XIFNVQk1BUklORQ=="),
                instantiatePermission: undefined,
