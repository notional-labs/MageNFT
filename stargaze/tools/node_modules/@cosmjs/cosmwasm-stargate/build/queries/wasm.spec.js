...
async function uploadContract(signer, contract) {
    ...
    const client = await stargate_1.SigningStargateClient.connectWithSigner(testutils_spec_1.wasmd.endpoint, signer, {
...
async function executeContract(signer, contractAddress, msg) {
    ...
    const firstAddress = (await signer.getAccounts())[0].address;
    const client = await signingcosmwasmclient_1.SigningCosmWasmClient.connectWithSigner(testutils_spec_1.wasmd.endpoint, signer, {
        ...testutils_spec_1.defaultSigningClientOptions,
        registry,
    });
    return client.signAndBroadcast(firstAddress, [theMsg], fee, memo);
